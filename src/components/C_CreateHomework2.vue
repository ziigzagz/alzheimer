    ...
    <div class="container">
      <div class="row">
        <div class="col mx-auto">
          <div class="row fs-1 text-center">CreateHomework2</div>
...
export default {
  ...
  mounted() {
    ...
    var i, j, txtid;
    for (i = 0; i < this.tabcolor; i++) {
      txtid = "btncolorplt" + (i + 1);
      console.log(this.colorlist[i]);
      document.getElementById(txtid).style.backgroundColor = this.colorlist[i];
      // document.getElementById(txtid).style.backgroundColor = "#523265";
